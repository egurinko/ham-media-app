...
import { queryField, stringArg, booleanArg, arg, nonNull, intArg } from 'nexus';
        ...
        await ctx.prisma.hospital.findMany({
          where: {
            ...
            hospitalInternalReputation: {
              star: args.internalReputationStar
                ? args.internalReputationStar
                : undefined,
            },
          },
        }),
