...
const BUSINESS_FORM_INSURANCE_ENABLED_1 = HOSPITAL_STATUSES.YES;
const BUSINESS_FORM_REMARK_1 = 'businessFormRemark1';
const CERTIFICATION_OPTION_NICHIJU_REGISTERED_1 = HOSPITAL_STATUSES.YES;
const CERTIFICATION_OPTION_JSAVA_REGISTERED_1 = HOSPITAL_STATUSES.YES;
const NIGHT_SERVICE_OPTION_STATUS_1 = HOSPITAL_STATUSES.YES;
const NIGHT_SERVICE_OPTION_REMARK_1 = 'nightServiceOptionRemark1';
const NIGHT_URGENT_ACTION_OPTION_STATUS_1 = HOSPITAL_STATUSES.YES;
...
const BUSINESS_FORM_INSURANCE_ENABLED_2 = HOSPITAL_STATUSES.YES;
const BUSINESS_FORM_REMARK_2 = 'businessFormRemark2';
const CERTIFICATION_OPTION_NICHIJU_REGISTERED_2 = HOSPITAL_STATUSES.YES;
const CERTIFICATION_OPTION_JSAVA_REGISTERED_2 = HOSPITAL_STATUSES.YES;
const NIGHT_SERVICE_OPTION_STATUS_2 = HOSPITAL_STATUSES.YES;
